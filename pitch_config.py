# Vendored from roboflow/sports (MIT license) — only the pieces this project
# actually uses, to avoid pulling in that package's much heavier optional
# dependencies (transformers, umap-learn/numba/llvmlite) that come with its
# unrelated SigLIP-based team classifier.
